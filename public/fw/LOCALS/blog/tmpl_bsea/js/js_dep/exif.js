...
function getImageData(oImg, fncCallback)
{
	BinaryAjax(
		...
		function(oHTTP) {
			...
			oImg.exifdata = oEXIF || {};
			/**
			 * alteration ioana Cristea - add parameter oImg to callback function
			 */
			if (fncCallback) fncCallback.call(oImg);
		}
	)
}
...
jQuery.fn.exifLoad = function(fncCallback, fnFinish) {
	alert("in exifLoad " + this.length);

	this.each(function(index){
		alert("in exifLoad i= " + index);
		var finish = EXIF.getData(this, fncCallback);
	});
